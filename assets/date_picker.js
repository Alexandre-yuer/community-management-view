...
function writeIframe()
{
    ...
    strIframe +="<td colspan=3 class=out><input style=' background-color: "+
        ...
        "    <tr><td><input style='width: 19' name=prevYear title='向前翻 1 年快捷键：↑' onclick='parent.prevY()' type=button value='&lt;&lt;'"+
        ...
        "    </td><td align=right><input  style='width: 19'  title='向后翻 1 月快捷键：→' name=nextMonth onclick='parent.nextM()' type=button value='&nbsp;&gt;'"+
        "    onfocus='this.blur()'><input  style='width: 19'  name=nextYear title='向后翻 1 年快捷键：↓' onclick='parent.nextY()' type=button value='&gt;&gt;'"+
